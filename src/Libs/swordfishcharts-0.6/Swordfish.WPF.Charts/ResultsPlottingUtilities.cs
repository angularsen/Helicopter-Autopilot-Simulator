...
namespace Swordfish.WPF.Charts
{
    public static class ResultsPlottingUtilities
    {
        ...
        /// polygons
        /// </summary>
        public const float alpha = 0.125f;
        ...
        {
            var retVal = new float[values.Length/2];
        ...
        {
            // TODO: use diagonal line algorithm, check for null inputs.


            var retVal = new float[personnelLevels.Length];
            ...
            else if (personnelLevels.Length == targets.Length)
            {
                ...
                throw (new ApplicationException(
                    "First Array needs to be twice the Length or equal to the length of the second"));
        ...
        public static float[] GetPercent(float[] numerator, float[] target, bool divideZeroGivesZero)
        {
            ...
            var retVal = new float[numerator.Length];
            ...
            {
                throw (new ApplicationException(
                    "First Array needs to be equal to or twice the Length of the second Array"));
            }
            return retVal;
        }
    }
