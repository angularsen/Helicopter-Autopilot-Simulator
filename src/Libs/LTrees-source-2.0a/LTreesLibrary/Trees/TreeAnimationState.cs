...
namespace LTreesLibrary.Trees
{
    ...
    public class TreeAnimationState
    {
        ...
        public static void Interpolate(TreeAnimationState state1, TreeAnimationState state2,
                                       TreeAnimationState destinationState, float f)
        {
            if (state1.BoneRotations.Length != state2.BoneRotations.Length ||
                state1.BoneRotations.Length != destinationState.BoneRotations.Length)
