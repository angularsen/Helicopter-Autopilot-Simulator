...
namespace LTreesLibrary.Trees
{
    ...
    public class TreeCrayon
    {
        ...
        private readonly List<Matrix> branchTransforms = new List<Matrix>();
        private readonly TreeSkeleton skeleton = new TreeSkeleton();
        ...
        {
            skeleton.Leaves.Add(new TreeLeaf(state.ParentIndex, color, rotationRadians, size, state.ParentBoneIndex,
                                             axisOffset));
        }
